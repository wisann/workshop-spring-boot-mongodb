...
import com.wisan.workshopmongo.dto.AuthorDTO;
import com.wisan.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("22/03/2022"), "Partiu viagem! ", "Vou viajar para São Paulo. Abraços!", new AuthorDTO(maria));
